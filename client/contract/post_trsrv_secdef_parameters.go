...
// NewPostTrsrvSecdefParams creates a new PostTrsrvSecdefParams object
// with the default values initialized.
func NewPostTrsrvSecdefParams() *PostTrsrvSecdefParams {
	var ()
	return &PostTrsrvSecdefParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostTrsrvSecdefParamsWithTimeout creates a new PostTrsrvSecdefParams object
...
// NewPostTrsrvSecdefParamsWithContext creates a new PostTrsrvSecdefParams object
...
// NewPostTrsrvSecdefParamsWithHTTPClient creates a new PostTrsrvSecdefParams object
...
/*PostTrsrvSecdefParams contains all the parameters to send to the API endpoint
for the post trsrv secdef operation typically these are written to a http.Request
*/
...
func (o *PostTrsrvSecdefParams) WithContext(ctx context.Context) *PostTrsrvSecdefParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostTrsrvSecdefParams) WithBody(body PostTrsrvSecdefBody) *PostTrsrvSecdefParams {
	o.SetBody(body)
	return o
}
