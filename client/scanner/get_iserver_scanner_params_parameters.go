...
// NewGetScannerParamsParams creates a new GetScannerParamsParams object
// with the default values initialized.
func NewGetScannerParamsParams() *GetScannerParamsParams {

	return &GetScannerParamsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetScannerParamsParamsWithTimeout creates a new GetScannerParamsParams object
...
// NewGetScannerParamsParamsWithContext creates a new GetScannerParamsParams object
...
// NewGetScannerParamsParamsWithHTTPClient creates a new GetScannerParamsParams object
...
/*GetScannerParamsParams contains all the parameters to send to the API endpoint
...
func (o *GetScannerParamsParams) WithTimeout(timeout time.Duration) *GetScannerParamsParams {
...
func (o *GetScannerParamsParams) WithContext(ctx context.Context) *GetScannerParamsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetScannerParamsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
